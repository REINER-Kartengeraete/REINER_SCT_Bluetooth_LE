//
//  CCIDESCTestPage.swift
//  reiner_ccid_via_dk_sample
//
//  Created by Prakti_E on 01.03.17.
//  Copyright © 2017 Reiner SCT. All rights reserved.
//
...
class CCIDESCTestPage: UIViewController, BluetoothTestProtocol, CCIDReaderCallbacks {
    ...
    func didRecieveCCID_DataBlock( _ ccid_AnswerBlock: CCID_AnswerBlock) {
        ...
        if (currentCCIDState == CCIDState.connected) {
            currentCCIDState = CCIDState.secure
        ...
        if (currentCCIDState == CCIDState.secure) {
